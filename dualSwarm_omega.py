...
aut.varlist['sys']=['known_room1','known1','pos1','home1','known_room2','known2','pos2','home2','turn']
aut.prime_varlists()
...
pd.write_pdf('duak_game_states_omega.pdf')